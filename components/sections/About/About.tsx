    ...
    <div className="ui-container">
      <div className="md:flex md:justify-between md:pb-16">
        <div className="md:flex md:flex-col md:justify-between">
          ...
          <div className="hidden md:block md:w-[221px] md:text-16 md:leading-1.25">
        ...
        <div className="w-180 ml-auto text-14 font-normal leading-1.43 pb-10 md:hidden">
          <p className="uppercase">
            <span className="block">From vacationers</span>
            <span className="block text-right">to active travelers</span>
          </p>
      ...
      <p className="text-14 font-extralight leading-1.43 md:ml-[241px] md:text-16 md:leading-1.25">
